...
def core_06():
    ...
    piesse1 = Component('PS1',0 ,10)
    piesse2 = Component('PS2',10 ,10)
    piesse3 = Component('PS3',0 ,10)
    piesse1.setOwner(piesse)
    piesse2.setOwner(piesse)
    piesse3.setOwner(piesse)
    
    bus = AndGate('BUS',10 ,0)
    bus.setOwner(global_top)

    bus1 = Component('BUS1',0,15)
    bus2 = Component('BUS2',0,15)
    bus1.setOwner(bus)
    bus2.setOwner(bus)
    ...
    voter1 = Component('Voter1',0,15)
    voter2 = Component('Voter2',0,15)
    voter1.setOwner(voter)
    voter2.setOwner(voter)
    ...
    cpu1 = Component('CPU1',0, 10)
    cpu2 = Component('CPU2',0 ,10)
    cpu3 = Component('CPU3',0 ,10)
    cpu1.setOwner(cpu)
    cpu2.setOwner(cpu)
    cpu3.setOwner(cpu)
    ...
    mmi1 = Component('MMI1', 10,10 )
    mmi2 = Component('MMI2',10 ,10 )
    mmi1.setOwner(mmi)
    mmi2.setOwner(mmi)
    ...
    tiu1 = Component('TIU1',10 ,10 )
    tiu2 = Component('TIU2',10 ,10 )
    tiu1.setOwner(tiu)
    tiu2.setOwner(tiu)
    ...
    odo1 = Component('ODO1',0 ,10 )
    odo2 = Component('ODO2', 0,10)
    odo1.setOwner(odo)
    odo2.setOwner(odo)
    ...
    rtm1 = Component('RTM1', 10,10 )
    rtm2 = Component('RTM2', 0,10)
    rtm1.setOwner(rtm)
    rtm2.setOwner(rtm)
